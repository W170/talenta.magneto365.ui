                    ...
                    messages.map(({ content, id }) => (
                        <ChatQuestionnaireQuestion key={id} questionWithAnswer={content} >
                            <ChatQuestionnaireMessageCandidate questionWithAnswer={content} onChange={saveAnswer}>
                                {content.question.answerType === EQuestionType.unique && <ChatQuestionnaireUniqueChoice questionWithAnswer={content} onChange={saveAnswer} />}
                                {content.question.answerType === EQuestionType.multiple && <ChatQuestionnaireMultipleChoice questionWithAnswer={content} onChange={saveAnswer} renderSubmitButton={(args) => <button {...args}>Guardar</button>} />}
