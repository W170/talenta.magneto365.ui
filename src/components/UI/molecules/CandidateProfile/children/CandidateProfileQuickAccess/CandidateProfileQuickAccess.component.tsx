                                ...
                                {child.children?.map((item, itemIndex) => {
                                    ...
                                    return (
                                        <div key={itemIndex} className={cx('magneto-ui-candidate-profile__quick-access-item')}>
                                            ...
                                            <p className={cx('magneto-ui-candidate-profile__quick-access-label')}>{item?.data}</p>
                                            <p className={cx('magneto-ui-candidate-profile__quick-access-text')}>{item.value}</p>
                                        </div>
                                    );
                                })}
                            </div>
