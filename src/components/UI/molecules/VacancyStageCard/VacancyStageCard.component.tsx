...
const Component: React.FC<IVacancyStageCard> = ({ stageDetail }) => {
  const textStyle = useCallback((text?: IVacancyStageCardText) => {
    return cx(
      'magneto-ui-vacancy-stage-card__text',
  ...
  return (
    <div className={cx('magneto-ui-vacancy-stage-card')}>
      <div
        className={cx('magneto-ui-vacancy-stage-card__container', {
          'magneto-ui-vacancy-stage-card__container--open': isOpen
        })}
      >
        <div className={cx('magneto-ui-vacancy-stage-card__container-header')}>
          ...
          <div
            className={cx('magneto-ui-vacancy-stage-card__container-header__button', {
              'magneto-ui-vacancy-stage-card__container-header__button--open': isOpen
            })}
