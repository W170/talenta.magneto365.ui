...
class DesignToken {
  // Updated paths for monorepo package structure
  tokensDir = path.resolve(__dirname, '../data')
  scssOutput = path.resolve(__dirname, '../src/scss')
  typesOutput = path.join(__dirname, '../src/index.ts')
  ...
  run() {
    ...
    // Generate a TS file containing all tokens types
  ...
  // Write TypeScript types (direct exports, no module declaration)
