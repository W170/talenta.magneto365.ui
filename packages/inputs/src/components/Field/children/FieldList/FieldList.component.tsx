...
import { Item, Wrapper, Body } from './children'
import { useFieldContext } from '../../Field.context'
import { combineRefs } from '../../Field.constant'
import { classNames, renderChildren } from '@magneto365-ui/shared'
...
function BaseComponent<T extends FieldListValue>(
  ...
  return (
    <ListContext.Provider value={{ isInsideList: true, toggleValue, value }}>
      {/* TODO: Re-enable Responsive wrapper after MobileDrawer migration */}
      <div
        {...props}
